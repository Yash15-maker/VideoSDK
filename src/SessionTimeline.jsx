...
export default function MeetingTimeline({ meetingData }) {
  const meetingStart = new Date(meetingData.start);
  const meetingEnd = new Date(meetingData.end);
              ...
              {participant.timelog.map((session, sessionIndex) => (
                <div key={`join-${sessionIndex}`}>
                  <div
                    ...
                    style={{ left: `${getPositionOnTimeline(session.start)}%` }}
                  >
                  ...
                  <div
                    className="absolute top-1/2 transform -translate-y-1/2 translate-x-1/2"
                    style={{ left: `${getPositionOnTimeline(session.end)}%` }}
                  >
                    <div
              ...
              {participant.events.mic.map((micEvent, micIndex) => (
                <div key={`mic-${micIndex}`}>
                  <div
                    ...
                    style={{
                      left: `${getPositionOnTimeline(micEvent.start)}%`,
                    }}
                  >
                  ...
                  <div
                    className="absolute top-2 transform translate-x-1/2"
                    style={{ left: `${getPositionOnTimeline(micEvent.end)}%` }}
                  >
              ...
              {participant.events.webcam.map((camEvent, camIndex) => (
                <div key={`cam-${camIndex}`}>
                  <div
                    ...
                    style={{
                      left: `${getPositionOnTimeline(camEvent.start)}%`,
                    }}
                  >
                  ...
                  <div
                    className="absolute bottom-2 transform translate-x-1/2"
                    style={{ left: `${getPositionOnTimeline(camEvent.end)}%` }}
                  >
                    <div className="w-5 h-5 bg-gray-600 rounded-full flex items-center justify-center">
                ...
                (screenEvent, screenIndex) => (
                  <div key={`screen-${screenIndex}`}>
                    <div
                      ...
                      style={{
                        left: `${getPositionOnTimeline(screenEvent.start)}%`,
                      }}
                    >
                    ...
                    <div
                      className="absolute top-0 transform translate-x-1/2"
                      style={{
                        left: `${getPositionOnTimeline(screenEvent.end)}%`,
                      }}
                    >
                      <div className="w-5 h-5 bg-gray-600 rounded-full flex items-center justify-center">
              ...
              {participant.events.errors &&
                participant.events.errors.map((error, errorIndex) => (
                  <div
                    ...
                    className="absolute top-1/2 transform -translate-y-1/2 -translate-x-1/2"
                    style={{ left: `${getPositionOnTimeline(error.start)}%` }}
                  >
